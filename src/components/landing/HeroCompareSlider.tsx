...
export function HeroCompareSlider() {
  ...
  return (
    <section className="relative isolate overflow-hidden cream-surface-alt py-20">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div
          ref={wrapRef}
          className="luxury-card relative mx-auto aspect-[16/10] w-full max-w-3xl select-none overflow-hidden rounded-3xl"
          onPointerDown={(e) => {
