      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          mainEntity: [
            ...
            { "@type": "Question", name: "Is there a free plan?", acceptedAnswer: { "@type": "Answer", text: "Yes. The Free plan includes 3 repurposes per month with no credit card required." } },
